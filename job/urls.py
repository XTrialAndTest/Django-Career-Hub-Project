...
urlpatterns = [
    ...
    path('job_applications/<slug:job_category_slug>/<slug:slug>',
         views.job_application, name="job_application"),
    path('job_creation_edit/<int:id>',
         views.job_creation_edit, name="job_creation_edit"),
    path('job_creation', views.job_creation, name="job_creation"),


    path('my_application', views.applicant_job_display, name="my_application"),
